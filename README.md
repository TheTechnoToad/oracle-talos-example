...
5. [Follow this tutorial under "Upload image" to generate Oracle image (you can skip the factory step and use the one in prerequisites)](https://www.talos.dev/v1.9/talos-guides/install/cloud-platforms/oracle/#upload-image)
